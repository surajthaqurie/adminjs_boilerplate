...
const api_endpoints: string[] = [
  ...
  "./src/backend/routes/setting.route.ts",
  "./src/backend/routes/page.route.ts",
  "./src/backend/routes/contact.route.ts",
  "./src/backend/routes/offer.route.ts"
];
...
const doc = {
  ...
  definitions: {
    ...
    SettingDetail: {
      success: true,
      data: {
        id: "c6b2a8bb-a9fc-4317-bab9-7f9ab76b3a12",
        key: "ios",
        value: "https://www.ios.com",
        createdAt: "2023-06-16T03:38:31.148Z",
        updatedAt: "2023-06-16T03:38:31.148Z"
      }
    },
    FAQList: {
      success: true,
      data: [
        {
          id: "618d18c6-d20a-4944-a741-c1e2ca7fd6af",
          title: "What are the benefits of the Online sweepstakes?",
          description:
            "<p>Convenience: Players can access online games from anywhere at any time.</p><p>Variety of games: Online sweepstakes offer a more comprehensive game range than traditional casinos.</p><p>Bonuses and promotions: Online sweepstakes often offer generous bonuses and promotions to attract and retain players.</p><p>Lower stakes:&nbsp;offer lower minimum bets compared to traditional casinos, allowing players to play with less money.</p><p>Anonymity: Players can remain anonymous while playing online games.</p><p>Better odds: Online games often have lower overhead costs, which translates to better odds for players.</p>"
        }
      ]
    },
    PageList: {
    ...
    OfferList: {
      ...
      data: [
        {
          id: "35acab7a-3816-4e0d-83c8-c213071eba39",
          amount: 1000,
          bonus: 200,
          createdAt: "2023-07-21T12:46:54.285Z",
          updatedAt: "2023-07-21T12:46:54.285Z"
        }
      ]
    }
  }
